        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/contact" className="hidden lg:block">
              <motion.span
                className="inline-flex items-center gap-2 bg-lime text-charcoal px-5 py-2.5 rounded-md text-sm font-medium cursor-pointer bg-[#008C95]"
                whileHover={{ scale: 1.04, backgroundColor: '#008C95' }}
                whileTap={{ scale: 0.97 }}
              >
